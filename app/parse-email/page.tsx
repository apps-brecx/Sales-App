...
export default function ParseEmailPage() {
  ...
  async function handleParse(e: React.FormEvent) {
    ...
    const res = await fetch('/api/parse-email', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({ email_text: emailText, email_date: emailDate, assigned_to: assignedTo ? Number(assignedTo) : null }) });
  ...
  return (
    <AppShell>
      <div className="p-8 max-w-3xl">
        <div className="mb-8">
          <h1 className="page-title">Parse Email</h1>
          <p className="page-sub">Paste your salesman's daily email — AI extracts leads and logs updates automatically</p>
        </div>
            ...
            {result.success ? (
              <>
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-emerald-700 font-semibold">✓ Email processed</span>
